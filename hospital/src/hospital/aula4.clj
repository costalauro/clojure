...
(defn simula-um-dia-em-paralelo-com-mapv-refatorada
  ...
  (let [hospital (atom (h.model/novo-hospital))
        pessoas ["111", "222", "333", "444", "555", "666"]
        starta-thread-de-chegada #(.start (Thread. (fn [] (chega-em-bonzinho! hospital %))))]
...
(defn simula-um-dia-em-paralelo-com-partial-extraida
  []
  (let [hospital (atom (h.model/novo-hospital))
        pessoas ["111", "222", "333", "444", "555", "666"]
...
;(simula-um-dia-em-paralelo-com-partial-extraida)





(defn simula-um-dia-em-paralelo-com-seq
  "Realmente estou preocupado em executar os elementos da sequencia"
  []
  (let [hospital (atom (h.model/novo-hospital))
        pessoas ["111", "222", "333", "444", "555", "666"]]
...
;(simula-um-dia-em-paralelo-com-seq)



(defn simula-um-dia-em-paralelo-com-do-times
...
(simula-um-dia-em-paralelo-com-do-times)
