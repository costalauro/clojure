...
(let [particular {:id 15, :nome "Lauro", :nascimento "11/03/1996", :situacao :urgente}
      plano {:id 15, :nome "Lauro", :nascimento "11/03/1996", :situacao :urgente, :plano [:raio-x, :ultrasom]}]
...
(let [particular {:id 15, :nome "Lauro", :nascimento "11/03/1996", :situacao :normal}
      plano {:id 15, :nome "Lauro", :nascimento "11/03/1996", :situacao :normal, :plano [:raio-x, :ultrasom]}]
  (pprint (deve-assinar-pre-autorizacao? {:paciente particular, :valor 1000, :procedimento :coleta-de-sangue}))
  (pprint (deve-assinar-pre-autorizacao? {:paciente plano, :valor 1000, :procedimento :coleta-de-sangue})))