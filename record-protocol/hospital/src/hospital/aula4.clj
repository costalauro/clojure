...
(let [particular (->PacienteParticular 15, "Lauro", "11/03/1996", :normal)
      plano (->PacientePlanoDeSaude 15, "Amanda", "22/06/1998", :normal,[:raio-x, :ultrasom])]
...
(let [particular (->PacienteParticular 15, "Lauro", "11/03/1996", :urgente)
      plano (->PacientePlanoDeSaude 15, "Amanda", "22/06/1998", :urgente,[:raio-x, :ultrasom])]
  (pprint (deve-assinar-pre-autorizacao? particular, :raio-x, 500))
  (pprint (deve-assinar-pre-autorizacao? particular, :raio-x, 40))
  (pprint (deve-assinar-pre-autorizacao? plano, :raio-x, 499990))
  (pprint (deve-assinar-pre-autorizacao? plano, :coleta-de-sangue, 499990)))
...
; vou deixar para ficar facil de comparar
...
; mas calma la, isso eh uma funcao normal!!! tradicional! podemos etestar!
